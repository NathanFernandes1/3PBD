...
VALUES 
    ('123.456.789-00', 'Maria Silva', '(11) 9999-8888', 'maria@email.com', '10/05/2023', 0),
    ('987.654.321-00', 'João Santos', '(11) 7777-6666', 'joao@email.com', '15/03/2023', 50.00);

-- Inserções para PROFISSIONAL
...
-- Inserções para ESPECIALIDADE_PROFISSIONAL
